                ...
                <div className="grid grid-cols-1 md:grid-cols-[0.7fr_1fr] gap-6"> {/* Змінено ширину колонок */}
                    ...
                    <div>
                        <p className="text-lg text-violet-950 mb-4">
                            Наш магазин працює для вас кожного дня, щоб ви могли придбати найкращі святкові товари у зручний для вас час.
                        </p>
                        <p className="text-lg text-violet-950 mb-4">
                            Ознайомтеся з нашим графіком роботи:
                        </p>
                        <ul className="text-lg text-violet-950 space-y-2">
                            <li>🕘 <strong>Понеділок - П’ятниця:</strong> 09:00 - 20:00</li>
                            <li>🕙 <strong>Субота:</strong> 10:00 - 18:00</li>
                            <li>🕛 <strong>Неділя:</strong> 11:00 - 17:00</li>
